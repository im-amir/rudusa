...
class CartScreen extends React.Component {
  ...
  render() {
    const {t, navigation, data, totals, loading, currency, webviewCheckout} = this.props;
    return (
      <ThemeConsumer>
        {({theme}) => (
                ...
                footerElement={
                  <View>
                    ...
                    <Button
                      ...
                      onPress={() => navigation.navigate(webviewCheckout ? mainStack.webview_checkout : mainStack.checkout)}
                    />
                  </View>
                }
                isShadow={false}
