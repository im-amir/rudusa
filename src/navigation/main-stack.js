...
import PrivacyScreen from 'src/screens/more/privacy';
import TermScreen from 'src/screens/more/term';
import ContactScreen from 'src/screens/more/contact';
import AboutScreen from 'src/screens/more/about';
...
import TermsPrivacyOptions from '../screens/TermsPrivacyOptions';
...
function MainStack() {
  return (
    <Stack.Navigator
      ...
      <Stack.Screen
        options={{headerShown: false}}
        name={mainStack.terms_privacy_options}
